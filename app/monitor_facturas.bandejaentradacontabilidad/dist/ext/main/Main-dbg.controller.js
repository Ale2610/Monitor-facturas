sap.ui.define(
    ...
    function(PageController) {
        ...
        return PageController.extend('monitorfacturas.bandejaentradacontabilidad.ext.main.Main', {
            onInit: function () {
                const oList = this.byId("FacturaList");
                const oBinding = oList.getBinding("items");
            
                if (oBinding) {
                    const oFilter = new sap.ui.model.Filter("Estado", sap.ui.model.FilterOperator.EQ, "Validación Contabilidad");
            ...
            onDetallePress: function (oEvent) {
                ...
                var sHash = "monitorfacturasbandejaentradac-display&/Facturas('" + facturaId + "')";
