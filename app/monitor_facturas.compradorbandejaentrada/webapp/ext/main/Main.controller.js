sap.ui.define(
    ...
    function(PageController) {
        ...
        return PageController.extend('monitorfacturas.compradorbandejaentrada.ext.main.Main', {
            onInit: function () {
                const oList = this.byId("FacturaList");
                const oBinding = oList.getBinding("items");
            
                if (oBinding) {
                    const oFilter = new sap.ui.model.Filter("Estado", sap.ui.model.FilterOperator.EQ, "Validación Comprador");
            ...
            onDetallePress: function (oEvent) {
                ...
                var sHash = "monitorfacturascompradorbandej-display&/Facturas('" + facturaId + "')";
